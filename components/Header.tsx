...
import { LayoutDashboard, Calendar, ListTodo, Wallet, Home, Globe, Settings, Trash2, X } from 'lucide-react';
...
const Header: React.FC<HeaderProps> = ({ activeView, setView, lang, setLang, onClearData }) => {
  ...
  return (
    <>
      <header className="sticky top-4 z-40 mx-4 rounded-2xl glass-panel shadow-lg shadow-blue-900/5 border-white/60 transition-all">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
              <nav className="flex gap-1 bg-slate-100/50 p-1 rounded-full backdrop-blur-sm overflow-x-auto scrollbar-hide max-w-[180px] sm:max-w-none">
              {navItems.map((item) => {
